...
class DisciplinaController {
	...
	public DisciplinaController() {
		...
		disciplinas.add(new Disciplina(1, "Amanda", "S", "Segurança", 3));
		disciplinas.add(new Disciplina(2, "Anakin", "C", "Direito", 2));
		disciplinas.add(new Disciplina(3, "Daemon", "D", "Filosofia", 4));
	}
